...
public class BlueFarAuto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectorySequence trajSeq = drive.trajectorySequenceBuilder(startPose)
                ...
                .splineToLinearHeading(new Pose2d(0, 0, 5*Math.PI/4), 5*Math.PI/8)
                ...
                .splineToLinearHeading(new Pose2d(0, 0, 5*Math.PI/4), 3*Math.PI/8)
                ...
                .splineToLinearHeading(new Pose2d(0, 0, 5*Math.PI/4), Math.PI)
                .splineToLinearHeading(new Pose2d(34, -30, 3*Math.PI/2), 3*Math.PI/2) // Spike 3
                .splineToConstantHeading(new Vector2d(34, -50), 3*Math.PI/2)
                .splineToLinearHeading(new Pose2d(0, 0, 5*Math.PI/4), 3*Math.PI)
                .splineToLinearHeading(new Pose2d(10, -20, Math.PI/2), 3*Math.PI/2)
                .build();

...
public class RedNearAuto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectorySequence trajSeq = drive.trajectorySequenceBuilder(startPose)
                ...
                .splineToConstantHeading(new Vector2d(-11.8,52), Math.PI/2)
                ...
                .splineToConstantHeading(new Vector2d(11.6,52), Math.PI/2)
                ...
                .splineToConstantHeading(new Vector2d(34,52), Math.PI/2)
                .splineToLinearHeading(new Pose2d(0, 0, 3*Math.PI/4), Math.PI)
